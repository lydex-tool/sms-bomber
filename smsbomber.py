...
while True:
 ...
 LYDEX ? SMS BOMBER    
    ...
    """.format(Fore.LIGHTRED_EX, len(servisler_sms), Style.RESET_ALL,
               Fore.CYAN))
  print(Fore.LIGHTGREEN_EX + "{/} " + Style.RESET_ALL + "Kurucu " +
        Fore.LIGHTGREEN_EX + Style.BRIGHT + "Lydex\n" + Style.RESET_ALL)
  try:
    menu = int(
  ...
  if menu == 1:
    ...
    try:
      print(
        Fore.LIGHTYELLOW_EX +
        "Telefon numarasını yazınız. (birden çoksa 'enter' bas): "
        + Fore.LIGHTGREEN_EX,
        end="")
      tel_no = input()
    ...
    print(Fore.LIGHTGREEN_EX + "{/} " + Style.RESET_ALL + "Kurucu " +
          Fore.LIGHTMAGENTA_EX + Style.BRIGHT + "Lydéx\n" +
          Style.RESET_ALL)
